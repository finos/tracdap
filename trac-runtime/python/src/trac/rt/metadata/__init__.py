...
#
#   trac_gen.domain.trac.metadata - TRAC domain objects for the runtime API
...
#
#   trac_gen.domain.trac.metadata -> trac.rt.metadata
#   trac_gen.proto.trac.metadata -> trac.rt.proto
#
