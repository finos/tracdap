...
class TracGenerator:
    ...
    def generate_file(self, src_loc, indent: int, descriptor: pb_desc.FileDescriptorProto) -> str:
        ...
        code = self.FILE_TEMPLATE \
            ...
            .replace("{ENUMS_CODE}", "".join(enums)) \
            .replace("{MESSAGES_CODE}", "".join(dataclasses))
    ...
    def generate_data_class(
        ...
        # Source location entries for this message
        ...
        nested_types = list(it.starmap(self.generate_data_class, zip(nested_types_ctx, nested_types_descriptors)))
    ...
    def generate_enum(self, ctx: LocationContext, descriptor: pb_desc.EnumDescriptorProto) -> str:
        ...
        code = self.ENUM_TEMPLATE \
            ...
            .replace("{DOC_COMMENT}", doc_comment) \
            .replace("{CLASS_NAME}", descriptor.name) \
            .replace("{ENUM_VALUES}", "".join(values_code))
