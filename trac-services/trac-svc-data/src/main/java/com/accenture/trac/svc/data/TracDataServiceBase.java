...
public class TracDataServiceBase extends CommonServiceBase {

    private final Logger log = LoggerFactory.getLogger(getClass());

    private final ConfigManager configManager;

    public TracDataServiceBase(ConfigManager config) {
    ...
    public static void main(String[] args) {
        ...
        CommonServiceBase.svcMain(TracDataServiceBase.class, args);
    }
}
