...
abstract class MetadataWriteApiTest implements IDalTestable {
    ...
    void createObject_publicTypesNotAllowed(ObjectType objectType) {
        ...
        var attrOps = TestData.generateAttrUpdates(tagToSave);
    ...
    void createObject_invalidAttrs() {
        ...
        var attrOps = TestData.generateAttrUpdates(invalidTag);
    ...
    void updateObject_ok(ObjectType objectType, Function<MetadataWriteRequest, TagHeader> saveApiCall) {
        ...
        var v2NewAttrValue = TagUpdate.newBuilder()
        ...
        var expectedTag = Tag.newBuilder()
                ...
                .putAttr(v2NewAttrName, v2NewAttrValue.getValue())
                .build();
    ...
    Tag updateObject_prepareV1(ObjectType objectType) {
        ...
        var attrOps = TestData.generateAttrUpdates(v1Tag);
    ...
    void updateObject_missingObject() {
        ...
        var v1Tag = TestData.dummyTagForObjectType(ObjectType.DATA);
    ...
    void updateObject_invalidAttrs() {
        ...
        var tagUpdates = Map.of(
                "very\nbroken.attr", TagUpdate.newBuilder()
                .setValue(MetadataCodec.encodeValue(1.0))
                .build());
    ...
    void updateObject_reservedAttrs() {
        ...
        var tagUpdates = Map.of(
                "trac_anything_reserved", TagUpdate.newBuilder()
                .setValue(MetadataCodec.encodeValue(1.0))
                .build());
    ...
    void updateTag_latestUpdated() {
        ...
        var v2Selector = TestData.selectorForTag(v2Header);
    ...
    void updateTag_reservedAttrs() {
        ...
        var t2AttrName = "trac_anything_reserved";
        var t2Update = TagUpdate.newBuilder()
                .setValue(MetadataCodec.encodeValue("First extra attr"))
                .build();
    ...
    void preallocateObject_updateTagBeforeSave() {
        ...
        var t2AttrName = "some_new_attr";
        var t2AttrUpdate = TagUpdate.newBuilder()
        ...
        var newTagRequest = MetadataWriteRequest.newBuilder()
                ...
                .setObjectType(ObjectType.DATA)
                .setPriorVersion(v1Selector)
                .putAttr(t2AttrName, t2AttrUpdate)
                .build();
