...
public class ConfigSecretsTest {
    ...
    public static final String TRAC_CONFIG_SECRET = "config/trac-secret.yaml";
    public static final String TRAC_RESOURCES_SECRET = "config/trac-secret-resources.yaml";
