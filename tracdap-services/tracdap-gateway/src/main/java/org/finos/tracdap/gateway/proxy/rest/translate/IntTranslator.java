...
public class IntTranslator implements IRequestTranslator<String> {

    private final Descriptors.FieldDescriptor fieldDescriptor;

    public IntTranslator(Descriptors.FieldDescriptor fieldDescriptor) {
    ...
    public Message.Builder translate(Message.Builder builder, String value) {
        ...
        try {
            ...
            if (fieldDescriptor.isRepeated())
                return builder.addRepeatedField(fieldDescriptor, intValue);
            else
                return builder.setField(fieldDescriptor, intValue);
        }
        catch (NumberFormatException e) {
            var message = String.format(RestApiErrors.INVALID_REQUEST_INTEGER_VALUE, value, fieldDescriptor.getName());
