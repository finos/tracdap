...
create table object_id (
    ...
    tenant_id smallint not null,
    object_pk bigint not null identity,
...
create table object_definition (
    ...
    tenant_id smallint not null,
    definition_pk bigint not null identity,

    object_fk bigint not null,
    object_version int not null,
    object_timestamp datetime2 not null,
    object_superseded datetime2 null,
    object_is_latest bit not null,
...
create table tag (
    ...
    tenant_id smallint not null,
    tag_pk bigint not null identity,

    definition_fk bigint not null,
    tag_version int not null,
    tag_timestamp datetime2 not null,
    tag_superseded datetime2 null,
    tag_is_latest bit not null,
