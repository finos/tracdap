...
abstract class MetadataDalReadTest implements IDalTestable {
    ...
    void loadByVersion_single() {
        ...
        var v1t1 = dal.loadObject(TEST_TENANT, selector1t1);
    ...
    void loadByVersion_batch() {
        ...
        var batch = dal.loadObjects(TEST_TENANT, List.of(selector1t1, selector2t1, selector2t2));
    ...
    void loadComboSelector_single() throws Exception {
        ...
        var combo1 = dal.loadObject(TEST_TENANT, selectCombo1);
    ...
    void loadComboSelector_batch() throws Exception {
        ...
        var batch = dal.loadObjects(TEST_TENANT, List.of(selectCombo1, selectCombo2, selectCombo3));
    ...
    void multiValuedAttr_single() {
        ...
        var loadedTag = dal.loadObject(TEST_TENANT, selector);
    ...
    void multiValuedAttr_batch() {
        ...
        dal.saveNewObjects(TEST_TENANT, List.of(origTag, origTag2));
        ...
        var batch = dal.loadObjects(TEST_TENANT, List.of(selector, selector2));
    ...
    void timeWindowBoundary_single() throws Exception {
        ...
        var v2BoundaryTag = dal.loadObject(TEST_TENANT, v2BoundarySelector);
        var v2PriorTag = dal.loadObject(TEST_TENANT, v2PriorSelector);
    ...
    void timeWindowBoundary_batch() throws Exception {
        ...
        var batch = dal.loadObjects(TEST_TENANT, List.of(v2BoundarySelector, v2PriorSelector));
    ...
    void missingItems_single() throws Exception {
        ...
        assertThrows(EMetadataNotFound.class, () -> dal.loadObject(TEST_TENANT, missing2));
        assertThrows(EMetadataNotFound.class, () -> dal.loadObject(TEST_TENANT, missing3));
    ...
    void missingItems_batch() throws Exception {
        ...
        assertThrows(EMetadataNotFound.class, () -> dal.loadObjects(TEST_TENANT, List.of(validSelector, missing2)));
        assertThrows(EMetadataNotFound.class, () -> dal.loadObjects(TEST_TENANT, List.of(validSelector, missing3)));
    ...
    void wrongObjectType_single() {
        ...
        assertThrows(EMetadataWrongType.class, () -> dal.loadObject(TEST_TENANT, selector));
    }
    ...
    void wrongObjectType_batch() {
        ...
        assertThrows(EMetadataWrongType.class, () -> dal.loadObjects(TEST_TENANT, List.of(selector, selector2)));
    }
}
