...
export interface Props {
     ...
     */
    name: "flows" | "inputs" | "models" | "parameters" | "policies"
    /**
     ...
     */
    onChangeLabel?: ActionCreatorWithPayload<{ name: "flows" | "inputs" | "models" | "policies", id: "showObjectId" | "showVersions" | "showCreatedDate" | "showUpdatedDate" }>
    /**
    ...
    onRefresh?: Function
    /**
     * A function to run to show information related to a selected item in the menu e.g. the selected flow.
     */
    onShowInfo?: () => void
    /**
     * A function to run that updates the 'showKeysInsteadOfLabels' prop value.
     */
    onShowKeys?: ActionCreatorWithPayload<{ name: "inputs" | "models" | "parameters" }>
    /**
            ...
            {show &&
                ...
                >
                    ...
                    <Dropdown.Menu className={"py-2"}>
                        ...
                        {onShowKeys && (name === "inputs" || name === "models" || name === "parameters") &&
...
ToolbarInner.propTypes = {
    ...
    name: PropTypes.oneOf(["flows", "inputs", "models", "parameters", "policies"]).isRequired,
