...
public class MetadataConstants {
    ...
    public static final String TRAC_SCHEMA_FIELD_COUNT_ATTR = "trac_schema_field_count";

    public static final String TRAC_DATA_ROW_COUNT_ATTR = "trac_data_row_count";
