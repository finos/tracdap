...
public class JsonFloat8Producer extends BaseJsonProducer<Float8Vector> {

    public JsonFloat8Producer(Float8Vector vector) {
        super(vector);
    }
    ...
    public void produceElement(JsonGenerator generator) throws IOException {
        ...
        double value = vector.get(currentIndex++);
