...
public class JsonDateDayProducer extends BaseJsonProducer<DateDayVector> {

    private static final DateTimeFormatter DATE_FORMATTER = DateTimeFormatter.ISO_LOCAL_DATE;

    public JsonDateDayProducer(DateDayVector vector) {
        super(vector);
    }
    ...
    public void produceElement(JsonGenerator generator) throws IOException {
        ...
        int unixEpochDay = vector.get(currentIndex);
